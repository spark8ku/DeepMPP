...
class network(nn.Module):
    def __init__(self, config):
        ...
        self.Linears = Linears(out_node_feats*2+out_edge_feats*2+out_graph_feats, hidden_dim, nn.LeakyReLU(), 2, dropout, False, False, last=True) 
    ...
    def forward(self, graph, node_feats, edge_feats, graph_feats, solv_graph, solv_node_feats, **kwargs):
